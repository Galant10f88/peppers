...
const style = {
    ...
    contentWrapper: '`bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r flex h-screen relative justify-center flex-wrap items-center',
    copyContainer: 'w-1/2',
    title: 'relative text-white text-[40px] font-semibold',
    description: 'text-white container-[400px] text-2xl mt-[0.8rem] mb-[2.5rem]',
    second: 'text-fuchsia-500 container-[400px] text-2xl mt-[0.8rem] mb-[2.5rem]',
    ctaContainer: 'flex',
