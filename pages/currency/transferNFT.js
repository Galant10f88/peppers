...
const style = {
    ...
    switch1: `relative text-lg font-semibold px-10 py-1 bg-black rounded-lg mr-5 text-cyan-300 hover:bg-black hover:text-cyan-300 border border-cyan-300 hover:border-cyan-300 shadow-lg hover:shadow-fuchsia-500/60 cursor-pointer`,
    switch2: `relative text-lg font-semibold px-8 py-1 bg-black rounded-lg mr-5 text-cyan-300 hover:bg-black hover:text-cyan-300 border border-black hover:border-cyan-300 shadow-lg hover:shadow-fuchsia-500/60 cursor-pointer`
}
