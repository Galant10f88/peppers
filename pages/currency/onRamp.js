...
const style = {
    ...
    ctaContainer: 'flex',
    accentedButton: 'relative text-lg font-semibold px-12 py-4 bg-cyan-500 rounded-lg mr-5 text-black hover:bg-[#fb4848] cursor-pointer',
    gameButton: 'relative text-lg font-semibold px-12 py-3 bg-cyan-500 rounded-lg mr-5 text-black hover:bg-fuchsia-400 border border-black hover:border-white  cursor-pointer',
    ...
    yes: `box-shadow: 1px 1px 1px 1px rounded-[2rem] border-2 border-fuchsia-400`,
